...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 column">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/book/allBook">全部书记</a>
        </div>
        <div class="col-md-4 column">
            <!--查询书籍-->
            <form action="${pageContext.request.contextPath}/book/queryBook" method="get">
                <span style="color: red; font-weight: bold">${error}</span>
                <input type="text" name="queryBookName" class="form-control" placeholder="请输入要查询书的名字">
